...
export function UserAuthForm({ className, ...props }: UserAuthFormProps) {
  ...
  async function onSubmit(data: FormData) {
    ...
    const signInResult = await signIn("email", {
      ...
      redirect: false,
      callbackUrl: searchParams.get("from") || "/notebooks",
      // callbackUrl: searchParams.get("from") || "/dashboard",
    })

    setIsLoading(false)

    console.log('dauphaihau debug: sign-in-result', signInResult)
        ...
        <div className="grid gap-2">
          <div className="grid gap-1">
            ...
            <input
              ...
              className="my-0 mb-2 block h-9 w-full rounded border border-[#cfd4d9] h-[36px] px-3 text-sm placeholder:text-[#cfd4d9] hover:border-slate-400 focus:border-brand-900 focus:outline-none "
              type="email"
              autoCapitalize="none"
              autoComplete="email"
              autoCorrect="off"
            ...
            <p className='text-sm mb-2 text-[#7d7b77]'>
