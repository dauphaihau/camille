          ...
          <>
            ...
            <div className='flex-1'>
              <div className='px-1 mb-5'>
                ...
                <Link
                  href={domain === 'notebooks' ? '/settings/workspace' : `/${domain}/settings/workspace`}
                  onClick={() => {
            ...
            <div className='flex-shrink px-4 py-3 inline-flex items-center border-t border-[#e9e9e8] hover:bg-[#ecebea] text-sm text-[#777572] cursor-pointer font-semibold'>
